...
from .datosTrabajador import trabajadores_data
...
class TrabajadorTestCase(unittest.TestCase):
    ...
    def test_registrar_sueldo_negativo(self):
        ...
        """
        resultado = self.persistencia.registrarTrabajador('Elena', -1200, 'June 2023')
    ...
    def test_registrar_nombres_iguales(self):
        ...
        """
        resultado = self.persistencia.registrarTrabajador('Isabel', 2000, 'January 2023')
